                            ...
                            <?php if (!empty($project_card) && is_array($project_card)): ?>
                                <?php $i=1; foreach ($project_card as $row): ?>
                                    <tr class=" text-center ">
                                        ...
                                        <td class="align-content-center"><p><?= $row['project_title']; ?></p></td>
                                        <td class="align-content-center"><p><?= $row['sub_title']; ?></p></td>
                                        <td class="align-content-center text-start"><p><?= $row['description']; ?></p></td>
                                        <td  class="align-content-center"><p class="text-center">Rs.<?= $row['goal_fund']; ?></p></td>
                                        <td  class="align-content-center"><p class="text-center">Rs.<?= $row['fund_raised']; ?></p></td>
                                        ...
                                        <td class =" align-content-center">
                                            <!-- Example actions -->
                                            <a href="<?= base_url('project/edit/' . $row['id']) ?>" class=" text-info fs-4  btn-sm"><i class="bi bi-pencil-square"></i></a>
                                            <a href="<?= base_url('project/delete/' . $row['id']) ?>"class=" ps-3 fs-4 text-danger" onclick="return confirm('Are you sure you want to delete this item?')"><i class="bi bi-trash3-fill"></i></a>
                                        </td>
                                    </tr>
                                <?php $i++; endforeach; ?>
