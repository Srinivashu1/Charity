...
<section class="edit">
    <div class="container">
        <div class="align-self-center">
            <form action="<?= base_url('fund_raise/update/'. $fund['id']); ?>" method="post"
                enctype="multipart/form-data">
                <h3 class="mb-4">Fund Raise Edit</h3>
                <div class="row mb-4">
                    <div class="col-2 ">
                        <label class="form-label ">Title:</label>
                    </div>
                    <div class="col">
                        <input type="text" name="fund_title" value="<?= $fund['fund_title']?>" class="form-control"
                            required>
                    </div>
                </div>
