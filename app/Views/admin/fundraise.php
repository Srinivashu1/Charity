                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body" style="padding:30px">
                            <div class="align-self-center">
                                <form action="<?= base_url('fund_raise_save/') ?>" method="POST" enctype="multipart/form-data">
                                    <div class="row mb-4">
                                        <div class="col-4 ">
    ...
    <section>
        <div class="container-fuild p-5 mt-2">
            <div class="d-flex justify-content-center">
                <div class="col-10">
                    <div class="row">
                        <div class="col-11"><h1 class="mb-4">Fund Raised List</h1></div>
                            ...
                            <?php if (!empty($fundcard) && is_array($fundcard)): ?>
                                <?php $i=1; foreach ($fundcard as $fund): ?>
                                    <tr class=" text-center ">
                                        ...
                                        <td class="align-content-center"><p><?= $fund['fund_title']; ?></p></td>
                                        <td class="align-content-center text-start"><p><?= $fund['description']; ?></p></td>
                                        <td  class="align-content-center"><p class="text-center">Rs.<?= $fund['goal_fund']; ?></p></td>
                                        <td  class="align-content-center"><p class="text-center">Rs.<?= $fund['fund_raised']; ?></p></td>
                                        ...
                                        <td class =" align-content-center">
                                            <!-- Example actions -->
                                            <a href="<?= base_url('fund_raise/edit/' . $fund['id']) ?>" class=" text-info fs-4  btn-sm"><i class="bi bi-pencil-square"></i></a>
                                            <a href="<?= base_url('fund_raise/delete/' . $fund['id']) ?>"class=" ps-3 fs-4 text-danger" onclick="return confirm('Are you sure you want to delete this item?')"><i class="bi bi-trash3-fill"></i></a>
                                        </td>
                                    </tr>
                                <?php $i++; endforeach; ?>
